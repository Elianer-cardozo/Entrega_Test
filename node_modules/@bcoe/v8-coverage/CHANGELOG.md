...
- **[Internal]** Fix continuous deployment script (stop confusing PRs to main
  with push to main)
...
- **[Internal]** Enable continuous deployment of the `main` branch.
...
- **[Feature]** Allow bump from either `main` or a branch with the same name as the tag (exampel: `v1.2.3`)
